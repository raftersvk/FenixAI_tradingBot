...
# --log-config none tells uvicorn to use Python root logger (already configured by server.py)
CMD ["uvicorn", "src.api.server:app", "--host", "0.0.0.0", "--port", "8000", "--log-config", "none"]
